...
class isNull extends SymDbComparison {
    constructor () {
        super();
    }
...
class isUndefined extends SymDbComparison {
    constructor () {
        super();
    }
...
module.exports.isNull = mkinstance(isNull);
module.exports.isUndefined = mkinstance(isUndefined);
